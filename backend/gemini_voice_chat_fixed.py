...
class GeminiVoiceChat:
    ...
    def print_banner(self):
        print("\n" + "="*60)
        print("       Gemini 2.0 Flash - Live Voice Chat")
        print("="*60)
        print("\nInstructions:")
...
SERVICES:
- Haircut (30 min, Rs. 500)
- Hair Coloring (90 min, Rs. 2000)  
- Facial (60 min, Rs. 1500)
- Manicure/Pedicure (45 min, Rs. 800)
- Massage (60 min, Rs. 1800)
