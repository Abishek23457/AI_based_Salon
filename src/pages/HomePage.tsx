...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Solutions Section */}
      <section id="solutions" className="py-20 px-6 bg-gradient-to-br from-emerald-50 via-white to-teal-50">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            Membership Solutions for <span className="text-emerald-700 italic">Modern Growth</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Investing in a membership means more than just software. It's about empowering your business with a digital workforce that scales with you.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto mt-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Digital Partner (Standard)</h3>
              <p className="text-gray-600 mb-6">
                24/7 intelligent customer service with natural language processing. Handle bookings, answer questions, and provide personalized recommendations.
              </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Smart Booking</h3>
              <p className="text-gray-600 mb-6">
                Intelligent appointment scheduling with conflict prevention, automated reminders, and seamless calendar integration.
              </p>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Staff Management</h3>
              <p className="text-gray-600 mb-6">
                Complete employee management with scheduling, performance tracking, and role-based access control.
              </p>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-100">
              ...
              <p className="text-gray-600 mb-6">
                Secure payment gateway integration with multiple payment methods, automated invoicing, and financial reporting.
              </p>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-8 border border-pink-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Voice Integration</h3>
              <p className="text-gray-600 mb-6">
                Advanced voice calling with speech-to-text, natural voice responses, and intelligent call routing.
              </p>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-center">
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Join the Growth Membership?
          </h2>
          <p className="text-xl text-emerald-100 mb-8">
            Empower your salon with a digital partner and automated workforce. Start your journey today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/login"
              className="bg-white text-emerald-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-50 transition"
            >
              Start Free Trial
            </Link>
            <a 
